<template>
  <div class="container mt-4">
    <div v-if="ejemplar" class="row justify-content-center">
      ...
      <div class="col-5 border p-2 text-align-left">
        <div>
          ...
          <p class="text-start"><strong>Stock:</strong> {{ ejemplar.stock }}</p>
          ...
          <button class="btn btn-success ms-2" @click="addToCart(ejemplar)">Añadir al carrito</button>
